...
// Fibonacci_App.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CFibonacciAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CFibonacciAppApp

CFibonacciAppApp::CFibonacciAppApp()
{
...
// Único objeto CFibonacciAppApp
CFibonacciAppApp theApp;


// Inicialización de CFibonacciAppApp

BOOL CFibonacciAppApp::InitInstance()
{
